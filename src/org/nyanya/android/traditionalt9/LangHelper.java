...
public class LangHelper {
	...
	protected static int getIndex(LANGUAGE l) {
	    ...
	    protected static final int[][][] ICONMAP = {
			...
			{
					//Hebrew resources
					// Hebrew has no lowercase/uppercase so at the moment all images are identical
					{R.drawable.ime_he_text_lower, R.drawable.ime_he_text_lower, R.drawable.ime_he_text_lower},
